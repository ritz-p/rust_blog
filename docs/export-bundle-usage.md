...
このドキュメントは、リリースタグごとに CI で生成した `rust-blog-export-tools-<version>-x86_64-unknown-linux-gnu` を別リポジトリで使って `dist/` を生成する手順をまとめたものです。
...
- タグ: `v0.1.0`
- artifact: `rust-blog-export-tools-v0.1.0-x86_64-unknown-linux-gnu`
